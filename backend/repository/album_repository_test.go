...
func TestAlbumRepository_FindAll(t *testing.T) {
	...
	// Create test albums
	album1 := &models.Album{Title: "The Wall", Artist: "Pink Floyd", Price: 24.99}
	album2 := &models.Album{Title: "Dark Side of the Moon", Artist: "Pink Floyd", Price: 22.99}
...
func TestAlbumRepository_FindByID(t *testing.T) {
	...
	// Create a test album
	album := &models.Album{Title: "The Wall", Artist: "Pink Floyd", Price: 24.99}
...
func TestAlbumRepository_Update_NotFound(t *testing.T) {
	...
	album := &models.Album{ID: 99999, Title: "Test", Artist: "Test", Price: 9.99}
	err := repo.Update(context.Background(), album)
	assert.Equal(t, ErrNotFound, err)
}
...
func TestAlbumRepository_ContextCancellation(t *testing.T) {
	...
	album := &models.Album{Title: "Test", Artist: "Test", Price: 9.99}
